      (function () {
        ...
        /* ── Set email link without exposing to scrapers ── */
        ...
        window.addEventListener(
          ...
          function () {
            ...
            document.querySelector("nav").style.boxShadow =
              window.scrollY > 60 ? "0 4px 40px rgba(0,0,0,.3)" : "none";
          },
          { passive: true },
        );

        /* HERO ENTRANCE — set hidden first, then animate to visible */
        [
          "#hbadge",
          "#hbism",
          "#ht1",
        ...
        document.querySelectorAll(".fc").forEach(function (c) {
          c.addEventListener("mouseenter", function () {
            gsap.to(c, { scale: 1.012, duration: 0.4, ease: "power2.out" });
          });
        ...
        document.querySelectorAll(".cta-p").forEach(function (b) {
          b.addEventListener("mouseenter", function () {
            gsap.to(b, {
              boxShadow: "0 12px 60px rgba(212,160,64,.44)",
              duration: 0.35,
            });
          });
          b.addEventListener("mouseleave", function () {
            gsap.to(b, {
              boxShadow: "0 4px 30px rgba(212,160,64,.2)",
              duration: 0.35,
            });
          });
        });
        ...
        document.querySelectorAll(".mchip").forEach(function (c) {
          c.addEventListener("click", function () {
            document.querySelectorAll(".mchip").forEach(function (x) {
            ...
            gsap.to("#mr", {
              ...
              onComplete: function () {
                ...
                document.getElementById("mra").textContent =
                  c.dataset.a || "سُبْحَانَ اللَّهِ";
                gsap.to("#mr", {
                  opacity: 1,
                  y: 0,
                  duration: 0.45,
        ...
        (function () {
          ...
          new IntersectionObserver(
            ...
            { threshold: 0.1 },
          ).observe(document.getElementById("mgrid"));
        })();
        ...
        if (qpEl) {
          ...
          qpEl.addEventListener("mouseleave", function () {
            document.querySelectorAll(".wb").forEach(function (b) {
              gsap.killTweensOf(b);
              gsap.to(b, { scaleY: 1, opacity: 0.5, duration: 0.3 });
            });
          });
        }
        ...
        (function () {
          ...
          new IntersectionObserver(
            ...
            { threshold: 0.1 },
          ).observe(document.querySelector(".sprv"));
        })();
        ...
        (function () {
          ...
          new IntersectionObserver(
            function (entries) {
              if (entries[0].isIntersecting && !done) {
                ...
                if (varEl) {
                  ...
                  varEl.style.transform = "scale(.93)";
                  gsap.to(varEl, {
                    opacity: 1,
                    scale: 1,
                    duration: 1.1,
            ...
            { threshold: 0.2 },
          ).observe(document.querySelector(".verse-sec"));
        })();
...
════════════════════════ */
        ...
        function getPrayerTimes() {
          ...
          btn.innerHTML =
            '<span style="display:inline-block;animation:spin .7s linear infinite">↻</span>&nbsp; Locating you…';
          btn.disabled = true;
          ...
          navigator.geolocation.getCurrentPosition(
            function (pos) {
              ...
              /* Reverse geocode + prayer API in parallel */
              ...
              Promise.all([cityPromise, prayerPromise])
                .then(function (results) {
                  ...
                  parsed.forEach(function (p, i) {
                    ...
                    div.innerHTML =
                      ...
                      '<span class="p-t">' +
                      fmt +
                      (isCur ? '<span class="nbadge">Next</span>' : "") +
                      "</span>";
                  ...
                  document.getElementById("ptloc").innerHTML =
                    '<svg class="svg-i" width="12" height="12" viewBox="0 0 24 24" style="stroke:var(--g);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg> ' +
                    city;
                  document.getElementById("pthijri").textContent = hijri;
                  document.getElementById("pstatus").textContent =
                    "Prayer times loaded for your location.";
                  document.getElementById("cdnext").textContent = ptLabel;
                  btn.style.display = "none";

                  /* Animate rows in */
                  var rowEls = document.querySelectorAll("#prows .prow");
            ...
            function () {
              document.getElementById("pstatus").textContent =
                "Location denied. Enable location access and retry.";
        ...
        /* Wire up button — no inline onclick needed */
        document
          .getElementById("glocBtn")
          .addEventListener("click", getPrayerTimes);
      })();